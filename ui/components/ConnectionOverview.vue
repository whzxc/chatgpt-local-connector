...
const agents = computed(() => inventory.orderedAgents.value.filter(a => a.installed && a.enabled).slice(0, [4,6,8,10].includes(maxVisibleAgents.value) ? maxVisibleAgents.value : 4));
