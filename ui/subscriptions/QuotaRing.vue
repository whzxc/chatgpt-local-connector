...
<style scoped>
.quota-ring{display:flex;align-items:center;flex-direction:column;gap:6px;width:40px;color:var(--rail-ink);font-variant-numeric:tabular-nums}.quota-dial{width:36px;height:36px;position:relative}.quota-dial>svg:not(.activity-arc){width:36px;height:36px;overflow:visible;transform:rotate(-90deg)}circle{fill:none;stroke-width:var(--quota-ring-width)}.track{stroke:var(--rail-track)}.value{stroke:var(--quota-color);stroke-linecap:round}.quota-dial img{position:absolute;inset:10px;width:16px;height:16px;filter:brightness(0) invert(1)}.quota-number{font-family:ui-rounded,'SF Pro Rounded',-apple-system,sans-serif;font-size:13px;font-weight:500;line-height:16px}.stale{opacity:.55}.unknown .quota-number{color:var(--rail-muted)}
</style>
