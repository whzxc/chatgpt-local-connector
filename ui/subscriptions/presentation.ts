...
export const errorLabels:Record<string,string>={'credentials-missing':'usageCredentialsMissing','credentials-expired':'usageCredentialsExpired','credential-access-denied':'usageCredentialDenied','no-subscription':'usageNoSubscription','no-limits-reported':'usageNoLimits','rate-limited':'usageRateLimited','network-error':'usageNetworkError','invalid-response':'usageInvalidResponse','unsupported-platform':'usageUnsupported'};
